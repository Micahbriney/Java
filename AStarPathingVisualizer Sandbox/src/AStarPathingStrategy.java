...
//    private Map<Point, CurNode> openList = new LinkedHashMap<Point, CurNode>();
////    private List<CurNode> openList = new LinkedList<>();
//    private List<Point> closedList = new LinkedList<Point>();
//    private List<Point> neighbors = new LinkedList<Point>();
//    private CurNode currentNode;
...
//        openList.add(currentNode);
        ...
        while(!openList.isEmpty()){     // Keep checking until all open nodes have been checked
            ...
            currentNode = openList.values().stream().sorted(Comparator.comparingInt(CurNode::getF)).collect(Collectors.toList()).iterator().next();
...
//            openList.remove(currentNode);
            ...
            neighbors = potentialNeighbors.apply(currentNode.nodePosition)     // Returns stream of cardinal points around currentNode
