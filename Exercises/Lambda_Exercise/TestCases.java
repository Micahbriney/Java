...
public class TestCases
{
   ...
   private <T> List<T> mapIt(List<T> list, Function<T,T> func)
   {
      ...
      {
         results.add(func.apply(value));     // Apply passed in method to value from list
      }
   ...
   public void testExercise1()
   {
      ...
      assertEquals(8, func.applyAsLong(7));  // operand x = 7. x -> x + 1 = 7 + 1 = 8
   }
   ...
   public void testExercise5()
   {
      ...
      final List<String> result = mapIt(strings, String::toLowerCase);  //method reference operator
   ...
   public void testExercise6()
   {
      ...
      final List<Integer> result = filterIt(numbers, x -> (x & 1) == 0); // 2, 4 bitwise operation
   ...
   public void testExercise7()
   {
      ...
      final List<Integer> result = mapIt(
         filterIt(numbers, x -> (x & 1) == 0),  // 2, 4 bitwise operation
         x -> x * x);                           // square result 2 and 4
